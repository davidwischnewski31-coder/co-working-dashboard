...
interface AgentLogContentProps {
  embedded?: boolean
}
...
export function AgentLogContent({ embedded = false }: AgentLogContentProps) {
  ...
  return (
    <div className={embedded ? 'space-y-4' : 'space-y-6 variant-page'}>
      <section className="rounded-2xl border border-[#E8E2D8] bg-white p-5 shadow-sm sm:p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            {!embedded ? <h1 className="text-xl font-semibold text-[#1C1714] sm:text-2xl">Agent Log</h1> : null}
            <p className={`text-sm text-[#7A6F65] ${embedded ? '' : 'mt-1'}`}>
